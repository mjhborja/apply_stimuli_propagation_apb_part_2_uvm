...
## Note to reader
The review content, including references to the original source code, analysis, diagrams otherwise stated and overall presentation of the topic, is Martin's original contribution. The base line source codes are referenced from respective EDA Playground authors in earlier posts [[1](https://github.com/mjhborja/apply_stimuli_propagation_apb_part_1_uvm)]. The base line ARM timing diagrams that Martin annotated in Figures 5 through 9 are properties of ARM.
