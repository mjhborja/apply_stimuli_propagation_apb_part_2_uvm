...
## Note to reader
The review content, including references to the original source code, analysis, diagrams otherwise stated and overall presentation of the topic, is Martin's original contribution. The base line source code and diagrams, specifically Figure 5 through 9, for this post are not Martin's work.
